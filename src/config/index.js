const configuration = {
  ...
  OPTIMIZELY_FULL_STACK_SDK_KEY: process.env.OPTIMIZELY_FULL_STACK_SDK_KEY && process.env.OPTIMIZELY_FULL_STACK_SDK_KEY !== 'null' ? process.env.OPTIMIZELY_FULL_STACK_SDK_KEY : null,
  HOME_URL: process.env.HOME_URL && process.env.HOME_URL !== 'null' ? process.env.HOME_URL : null,
